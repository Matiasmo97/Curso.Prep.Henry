...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  var invertido = str.split(' ').reverse().join(' ');
...
function deleteAbc(cadena){
  ...
  //Escribe tu código aquí
  var deleteABC = cadena.replaceAll('a', '').replaceAll('b', '').replaceAll('c', '');
  return deleteABC;
}
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  //Escribe tu código aquí  
  const interseccion = require('lodash');
  var numerosComunes = interseccion.intersection(arreglo1, arreglo2);
